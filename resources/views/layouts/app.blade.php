    ...
    @else
      @php
        ...
        $navItems = [
          ...
          ['label' => 'Tugas Pertemuan', 'icon' => 'fa-solid fa-images', 'route' => 'meeting-assignments.index', 'active' => request()->routeIs('meeting-assignments.*') || request()->routeIs('meeting-submissions.*')],
        ];
          ...
          <div class="relative flex h-full flex-col">
            <div class="sidebar-brand flex h-20 items-center gap-3 border-b border-slate-100 px-6">
              ...
              <div class="sidebar-label min-w-0">
                ...
                <div class="text-xs font-semibold uppercase tracking-wider text-slate-400">BIMBEL GAMBAR VILLA MERAH</div>
              </div>
